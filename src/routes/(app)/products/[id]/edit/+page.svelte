...
<Card.Root class="max-w-2xl">
	<Card.Header>
		...
		<Card.Description>Editing: {data.product.name} ({data.product.sku})</Card.Description>
	</Card.Header>
	<Card.Content>
		<form method="POST" use:enhance class="space-y-4">
			<div class="grid gap-4 sm:grid-cols-2">
				...
				<div class="space-y-2">
					...
					<Input id="sku" name="sku" value={data.product.sku} required />
				</div>

				<!-- Name -->
				<div class="space-y-2">
					<Label for="name">Name *</Label>
					<Input id="name" name="name" value={data.product.name} required />
				</div>
			</div>
			...
			<div class="space-y-2">
				...
				<Textarea id="description" name="description" value={data.product.description ?? ''} />
			</div>
			...
			<div class="grid gap-4 sm:grid-cols-2">
				...
				<div class="space-y-2">
					...
					<Input
						...
						type="number"
						min="0"
						value={data.product.lowStockThreshold}
					/>
				</div>
			</div>
